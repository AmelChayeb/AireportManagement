...
Passenger passenger = new Passenger { FirstName = "amel", LastName = "chaieb", EmailAdress = "amelchaiebaouin@esprit.tn"};
...
Console.WriteLine(passenger.ToString());
Console.WriteLine(passenger.ToString());
Console.WriteLine(passenger.CheckProfile("Amel","chaieb")); 
Console.WriteLine(passenger.CheckProfile("miniar", "chaieb"));
Console.WriteLine(passenger.CheckProfile("amel", "chaieb","amelchaiebaouin@esprit.tn"));
...
//test atelier3
Console.WriteLine("-----------------------bASE de donnée atelier 3 test -----------------------");
